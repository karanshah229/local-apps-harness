...
- Start with professional neutral surfaces, clear hierarchy, and one restrained domain-derived accent. Use dark presentation, purple or indigo as the leading accent, and gradients only when the user explicitly requests them.
