...
1. Compare the completed work with its change record; account for every required surface.
...
Complete only when every required surface is verified, no unintended stale identifier remains, and rollback information is current.
