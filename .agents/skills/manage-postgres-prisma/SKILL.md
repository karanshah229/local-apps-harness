...
1. Resolve the registered database, Prisma schema, clients, and backup handler.
...
4. Generate a named migration, inspect its SQL, and test it against disposable representative data.
