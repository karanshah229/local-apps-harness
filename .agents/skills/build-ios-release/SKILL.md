...
description: Produce and verify an iOS Simulator build and locally signed IPA from a registered Expo app, including bundle identity, entitlements, signing, versioning, and optional TestFlight upload.
---
...
4. Build the signed IPA locally and record path, version, checksum, and source checkpoint in the registry.
