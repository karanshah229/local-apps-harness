...
description: Produce and verify an installable Android APK from a registered React Native Expo or Native Android Kotlin app, including package identity, permissions, signing, versioning, device checks, and artifact tracking.
---
...
3. Build the APK with the repository's local Expo/EAS profile or native Gradle release task (`./gradlew assembleRelease`); keep signing material local and untracked.
