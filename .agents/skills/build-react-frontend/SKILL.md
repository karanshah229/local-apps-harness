...
3. Preserve deployment below the base path across routing, assets, refresh, and API requests.
4. Implement relevant loading, empty, success, error, responsive, keyboard, and accessible-label states.
5. Test confirmed journeys at desktop and mobile widths; capture visual evidence for design requests.
